export default {
  ...
  rasterPath: '/map/highway-map',
  zone: 'Area 05',
  demoNote:
    'EA Build 1: Highway connects School and Outpost in the transit chain—not a direct Village→Minefield skip. Demo builds sometimes omitted Highway entirely.',
  highlights: [
