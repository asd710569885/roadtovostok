...
export const RASTER_MAP_PAGES = [
  {
    ...
    description:
      'Interactive Road to Vostok Village map: Area 05 starter zone, traders, fish pools, ground loot, containers & transitions—clickable pins on the full raster.',
    keywords:
    ...
    article:
      'The Village in Road to Vostok is the primary Area 05 safe hub and early progression anchor. This full-resolution raster—distinct from the zoomable world promo atlas—uses normalized pins aligned with the community map data: shelters and transitions, the Generalist trader, fish pools, and dense loot (containers, ground spawns) so you can plan routes before you deploy. Pair this page with our wiki walkthroughs for build-specific notes; pins are a field guide overlay, not in-game GPS.',
  },
  {
    mapModule: 'map02',
    ...
    description:
      'Road to Vostok Highway area map: connector roads, long sightlines, cover spots, and loot / POI pins on the high-res raster.',
    keywords:
  ...
  },
  {
    ...
    description:
      'Interactive School map in Road to Vostok: classrooms, vertical sightlines, loot clusters, and shelter/transitions on the full raster.',
    keywords:
  ...
  },
  {
    ...
    description:
      'Outpost area map: defensive angles, cover, loot, and map transitions on the high-resolution grid.',
    keywords:
    ...
    article:
      'Outposts condense PvE pressure into a compact footprint. Pins highlight transitions, stashes, and flammable or light sources (fires) to help you plan breach order and exfil. Cross-link to our NPC and weapons wikis for loadout ideas.',
  },
  {
    mapModule: 'map05',
    ...
    article:
      'The Minefield rewards patience: lane control matters more than raw DPS. Use the pin layers to map hazard bands versus high-tier crates, then read our dedicated Minefield wiki for seasonal visibility and quest hooks.',
  },
  {
    mapModule: 'map06',
  ...
  },
  {
    ...
    description:
      'Terminal / port map: shipping lanes, cover, and loot on the high-res raster, with ?pin= deep links.',
    keywords:
